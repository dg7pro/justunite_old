    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <form method="post" action="{{url('problems/castVote')}}" class="form-inline">
                    {{csrf_field()}}
                        ...
                        @if(Auth::guest())
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-success btn-xs" href="{{ url('loginToVote') }}">Login</a>
                                </td>
                            </tr>
                        @else
                            ...
                            @else--}}
                                <tr>
                                    ...
                                    <td>{{$problem->votes_count}}</td>
                                    {{--<td style="background-color: #06b0cf">--}}
                                    <td>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="newOption" id="newOption" value="{{$problem->id}}" {{ $problem->id == $receivedVoteProblemId ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                            {{--@endif--}}
                ...
                <button type="submit" class="btn btn-success btn-xs" style=" align-self: right">Vote</button>
                </form>
