<nav class="css-tab css-tab--active">
    <ul class="css-tab__list">
        ...
        <li class="css-tab__item">
            <a href="{{url('problems')}}" class="css-tab__link">
                <div class="css-tab__thumb color2" data-letter="B"></div>
                <p class="css-tab__label">Problems</p>
            </a>
        </li>
        <li class="css-tab__item">
            <a href="{{url('constituencies')}}" class="">
        ...
        <li class="css-tab__item">
            <a href="{{url('states')}}" class="">
                <div class="css-tab__thumb color5" data-letter="C"></div>
                <p class="css-tab__label">States</p>
            </a>
        </li>
        <li class="css-tab__item">
            <a href="{{url('polls')}}" class="css-tab__link">
